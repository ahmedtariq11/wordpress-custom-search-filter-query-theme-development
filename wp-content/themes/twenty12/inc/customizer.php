...
// Teaser Heading
    $wp_customize->add_setting('Teaser-heading1', array(
        'deafult' => _x('Teaser Heading1', 'pt1602'),
        'type' => 'theme_mod'
    ));
    $wp_customize->add_control('Teaser-heading1', array(
        'label' => __('Teaser Heading1', 'pt1602'),
        'section' => 'Teaser',
        'priority' => 2,
    ));
