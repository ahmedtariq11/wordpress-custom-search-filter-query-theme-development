  ...
  <div class="slider-wrapper theme-default">
    <div id="slider" class="nivoSlider">      	
        ...
        while ( $query->have_posts() ) : $query->the_post();
          $i++;
          $sd_hall_slideno[] = $i;
          $sd_hall_slidetitle[] = get_the_title();
		  $sd_hall_slidedesc[] = get_the_excerpt();
          $sd_hall_slidelink[] = esc_url(get_permalink());
          ?>
        ...
        <?php
        $k = 0;
        foreach( $sd_hall_slideno as $sd_hall_sln ){ ?>
    <div id="slidecaption<?php echo esc_attr( $sd_hall_sln ); ?>" class="nivo-html-caption">
      <div class="slide_info">
        <h2><?php echo esc_html($sd_hall_slidetitle[$k] ); ?></h2>
        <p><?php echo esc_html($sd_hall_slidedesc[$k] ); ?></p>
        <div class="clear"></div>
        <a class="slide_more" href="<?php echo esc_url($sd_hall_slidelink[$k] ); ?>">
          <?php esc_html_e('View Our Venue', 'sd-hall');?>
        </a>
      </div>
    </div>
 	<?php $k++;
        ...
        <?php
                    if ( have_posts() ) :
						...
						the_posts_pagination( array(
							'mid_size' => 2,
							'prev_text' => esc_html__( 'Back', 'sd-hall' ),
							'next_text' => esc_html__( 'Next', 'sd-hall' ),
						) );
                    else :
